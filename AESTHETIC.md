...
| Tone | 説明 |
|------|------|
| brutally minimal | 装飾を徹底排除、タイポと余白だけで構成 |
| maximalist | 重なり・色数・装飾を恐れずに押し込む |
| retro-futuristic | 70-90s SF / Y2K / vaporwave 等の時代感 |
| organic / natural | 不整形・手描き感・有機的曲線 |
| luxury / refined | 余白・上質紙・thin serif・控えめな金属感 |
| playful / toy-like | 丸み・原色・弾むようなモーション |
| editorial / magazine | 雑誌的グリッド・タイポ強調・写真主役 |
| brutalist / raw | むき出しのHTMLっぽさ・モノスペース・border強調 |
| art deco / geometric | 幾何学・対称・装飾的フレーム |
| soft / pastel | 低彩度・低コントラスト・柔らかいシャドウ |
| industrial / utilitarian | ターミナル/CAD風・密度高・装飾レス |
